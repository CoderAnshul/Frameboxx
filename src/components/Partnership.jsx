    ...
    <section id="partnership" className="relative py-24 px-8 w-full max-w-7xl mx-auto overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="glass-card p-10 rounded-3xl bg-black/60 border border-white/10 relative overflow-hidden group cursor-target">
          ...
          <h3 className="text-3xl font-accent text-white uppercase mb-6 leading-none">Frameboxx <br/><span className="text-gray-500">2.0 Animation.</span></h3>
        ...
        <div className="glass-card p-10 rounded-3xl bg-black/60 border border-white/10 relative overflow-hidden group cursor-target">
          ...
          <h3 className="text-3xl font-accent text-white uppercase mb-6 leading-none">Godspeed <br/><span className="text-gray-500">Games Studio.</span></h3>
          <p className="text-gray-400 text-sm leading-relaxed mb-8">
